        ...
        <form method="post" action="register.php">
          ...
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="password" id="confirmPassword" class="form-control" name="cpass" placeholder="Confirm password" required="required">
                  <label for="confirmPassword">Confirm password</label>
                </div>
              </div>
            </div>
          </div>
          <input type="submit" class="btn btn-primary btn-block" value="Register" name="btn_reg">
        </form>
...
if (isset($_POST['btn_reg'])){
    ...
    $selectQuery = "SELECT * FROM usertable WHERE Email='$email'";
    $result = mysqli_query($conn,$selectQuery);
    $num = mysqli_num_rows($result);
    if ($num==1){
        echo "Username Already Exists <a href='index.php'>Ok</a>";
        die();
    }else if ($password != $confirm_pass){
        echo "Passwords Don't match";
    }else{
            $regQuery = "INSERT INTO `users`(`id`, `FirstName`, `LastName`, `Email`, `Password`) VALUES (null ,'$fname','$lname','$email','$password')";
