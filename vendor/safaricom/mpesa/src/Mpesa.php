...
class Mpesa
{
    ...
    */
    public static function env($env_param){
      ...
      //Added our custom array with env values

        $data=array("MPESA_CONSUMER_KEY"=>"XrU7OkGdyL3EJq2aVd7SaIU684d9DCuE", "MPESA_CONSUMER_SECRET"=>"kpa4Tkx5we2qvLqF","MPESA_ENV"=>"sandbox");
        return $data[$env_param];
    }
    /**
